<div class="row">
    <h4 class="text-primary text-center">Zona de Venda</h4>
    <form method="post">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-xl-12 col-xxl-12">
                <input type="text" class="form-control" id="pesq_palavra_venda" Placeholder="Pesquise por Palavras Chave (Ex:Canário)">
            </div>
        </div>
    </form>
</div>
...
<div class="row" id="mostra_ave_default">
    <?php
        ...
        if(@$_SESSION["log_id"] == null){
            $aves_venda = mysqli_query($conn, "Select * from ave where ave_estado = 1");
        }else if (@$_SESSION["log_id"] != null){
            $aves_venda = mysqli_query($conn, "Select * from ave where ave_estado = 1 and ave_log_id != '$_SESSION[log_id]'");
        }
            ...
            echo '<div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3" style="margin-bottom: 1%;">
                <div class="card">
                    ...
                    $av = mysqli_fetch_array(mysqli_query($conn, "Select * from ave inner join especie on especie.esp_id = ave.ave_especie 
                                                    ...
                                                    where ave_estado = 1 and ave_id = '$ave_v[ave_id]'"));
