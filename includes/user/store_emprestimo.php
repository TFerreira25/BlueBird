...
<div class="row">
    <h4 class="text-primary text-center">Zona de Empréstimo</h4>
        <form method="post">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-xl-12 col-xxl-12">
                    <input type="text" class="form-control" id="pesq_palavra" Placeholder="Pesquise por Palavras Chave (Ex:Canário)">
                </div>
            </div>
        </form>
    <br>
...
<br>
<div class="row mt-2" id="mostra_ave">
</div>
<div class="row mt-2" id="mostra_ave_default">
    <?php
        include 'connections/conn.php';
        $aves_venda = mysqli_query($conn, "Select * from ave where ave_estado = 2 and ave_log_id != '$_SESSION[log_id]'");
            ...
            echo '<div class="col-sm-12 col-md-6 col-xl-4 col-xxl-3" style="margin-bottom: 1%;">
                <div class="card">
                    ...
                    $av = mysqli_fetch_array(mysqli_query($conn, "Select * from ave inner join especie on especie.esp_id = ave.ave_especie 
                                                    ...
                                                    where ave_estado = 2 and ave_id = '$ave_v[ave_id]'"));
